...
![](images/state-region-distribution-1.png)
...
![](images/example-of-smoothed-density-1.png)
...
![](images/simulated-density-1-1.png)
...
![](images/densities-different-smoothness-1.png)
...
![](images/two-densities-one-plot-1.png)
...
![](images/height-histogram-exercise-1.png)
...
![](images/data-and-normal-densities-1.png)
...
![](images/hist-qqplot-non-normal-data-1.png)
...
![](images/female-male-boxplots-1.png)
...
![](images/histogram-qqplot-female-heights-1.png)
...
data.frame(male_percentiles=male_percentiles,female_percentiles=female_percentiles)
```


3. Study the following boxplots showing population sizes by country:
![](images/boxplot-exercise-1.png)
...
```{r}
# answer: c. As seen in question 10, the normal approximation tends to underestimate the extreme values. It’s possible that there are more seven footers than we predicted.
```
...
![](images/female-male-boxplots-geom-1.png)
