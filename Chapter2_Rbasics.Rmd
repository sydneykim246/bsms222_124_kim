...
```{r}
## Code to compute solution to quadratic equation of the form ax^2+b+c
...
### 2.4.4 Vectors: numeris, characters, and logical
...
In a numeri vector, every entry must be a number.
...
<sort organizes actual figures, order organizes their index numbers>
...
temp<-c(35,88,42,84,81,30)
city<-c("Beijing","Lagos","Paris","Rio de Janeiro","San Juan","Toronto")
temps<-data.frame(name=city,temperature=temp)
temps
```
...
city<-c("Beijing","Lagos","Paris","Rio de Janeiro","San Juan","Toronto")
tempC<-(temp-32)*(5/9)
temps<-data.frame(name=city,temperature=tempC)
temps
```
